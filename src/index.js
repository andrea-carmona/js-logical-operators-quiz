...
// Push 'red' and 'blue' into the 'colors' array
colors.push("red", "blue");

console.log(colors); // This will output: ['red', 'blue']
...
console.log(
  "[Question #33]: ",
  stringVar.toLowerCase() === "hello".toLowerCase()
); // should print true

// 34. Check if 'booleanVar' is truthy.
if (!booleanVar) {
  console.log("[Question #34]: ", "yes its falsey"); // should print falsey
}
...
if (numberVar % 2 === 0) {
  console.log("[Question #40]: ", "numberVar is even");
} else {
  console.log("[Question #40]: ", "numberVar is odd");
}
...
console.log("[Question #43]: ", fruits.indexOf("banana") !== -1); // should print true
...
const squared = numberVar * numberVar;
...
console.log("[Question #49]: ", numberVar != 0); // should print true
...
if (weight < 70) {
  ...
  console.log("[Question #63]: ", "Underweight");
}
...
if (city.length > 6) {
  console.log(
    "[Question #75]: The length of 'city' is strictly greater than 6."
  );
} else {
  console.log(
    "[Question #75]: The length of 'city' is not strictly greater than 6."
  );
}
...
if (book.genre) {
  console.log(
    "[Question #79]: ",
    "The 'genre' property exists in the 'book' object."
  );
} else {
  console.log(
    "[Question #79]: ",
    "The 'genre' property does not exist in the 'book' object."
  );
}
...
console.log("[Question #87]: ", bookTitle.endsWith("1984")); // should print true

// 88. Check if the 'days' array is not empty.
console.log("[Question #88]: ", days.length > 0); // should print true
...
console.log("[Question #93]: ", bookTitle.startsWith("The")); // should print false

// 94. Using the appropriate method, reverse the order of elements in the 'planets' array.
console.log("[Question #94]: ", planets.reverse()); // should print reverse
...
console.log("[Question #98]: ", book.hasOwnProperty("isbn"));
